	...
	return (
		<View style={styles.root}>
			<View style={styles.group2Stack}>
				...
				<Image
					source={require('../assets/images/3c50a760b77dbb474637e2296a0f8d920177ca89.png')}
					resizeMode="cover"
			...
			<View style={styles.group3}>
				<View style={styles.rectangleStack}>
					...
					<Text style={styles.title3}>Uploading…</Text>
				</View>
			</View>
			...
			<Text style={styles.headline}>Cancel</Text>
			<Image
